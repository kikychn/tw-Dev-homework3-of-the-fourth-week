...
public class Receipt {
    ...
    public double CalculateGrandTotal(List<Product> products, List<OrderItem> items) {
        ...
        subTotal = calculateActualTotal(products, items, subTotal);
    ...
    private BigDecimal calculateActualTotal(List<Product> products, List<OrderItem> items, BigDecimal subTotal) {
